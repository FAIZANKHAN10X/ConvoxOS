...
export default function BroadcastsClient({
  ...
  // Server-supplied rows render immediately; the mount effect below
  // still refreshes once (cheap, keeps polling/status truthful).
  const [loading, setLoading] = useState(initialBroadcasts.length === 0);
