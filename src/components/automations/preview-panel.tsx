...
export function PreviewPanel({
  ...
  return (
    <div className="absolute inset-y-0 right-0 z-30 flex w-[min(100%,380px)] flex-col border-l border-border bg-card shadow-xl">
      ...
      <div className="flex-1 overflow-y-auto bg-[#f7f9fc] px-5 py-4">
        <div className="mx-auto max-w-[300px] rounded-2xl border border-border bg-slate-900 p-2 shadow-lg">
          <div className="flex min-h-[320px] flex-col gap-2 rounded-xl bg-card px-3 py-4">
            {messages.length === 0 && (
            ...
            {messages.map((message) => (
              <div key={message.id}>
                <div className="max-w-[85%] rounded-xl rounded-tl-sm bg-muted px-3 py-2">
        ...
        <p className="mx-auto mt-3 max-w-[300px] text-center text-[11px] leading-snug text-muted-foreground">
