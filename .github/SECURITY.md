...
In scope:
- Anything in this repository (`FAIZANKHAN10X/ConvoxOS`), including webhook
...
- Issues that require a pre-compromised deployment (e.g. a leaked
  ...
  compromise.
- Social engineering, physical attacks, or third-party services added after
  deploy.
...
Thanks for helping keep ConvoxOS safe.
